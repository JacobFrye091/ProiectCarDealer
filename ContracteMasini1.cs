...
{
    public partial class ContracteMasini1 : Form
    {
        public ContracteMasini1()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (comboBox1.Text != "")
            {
                ...
                SqlCommand command = new SqlCommand("Select * From ContracteMasiniV where NrContract = '" + comboBox1.SelectedItem.ToString() + "'", connection);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            command.CommandText = "Select Top(1) NrContract, RolContract, NumeVanzator, FunctiaVanzator, DomiciliuVanzator, JudetVanzator, CodPostalVanzator, SectorVanzator, StradaVanzator, NrStradaVanzator, NumeCumparator, FunctiaCumparator, DomiciliuCumparator, JudetCumparator, CodPostalCumparator, JudetCumparator, CodPostalCumparator, SectorCumparator, StradaCumparator, NrStradaCumparator, PretContract, DataContract From ContracteMasiniV order by NrContract desc";
            connection.Open();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "")
            {
                if (MessageBox.Show("Doriți să ștergeți înregistrarea?", "Ștergere Înregistrare", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    SqlConnection connection = new SqlConnection(@"Data Source=HP_ANDREI\SQLEXPRESS;Initial Catalog=ProiectLicenta;Integrated Security=True");
                    connection.Open();
                    SqlCommand command = new SqlCommand("DELETE FROM ContracteMasiniV WHERE NrContract='" + textBox1.Text + "'", connection);
                    command.ExecuteNonQuery();
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Hide();
                FacturiMasini1 f1 = new FacturiMasini1();
                f1.Show();
            }
        }
    }
